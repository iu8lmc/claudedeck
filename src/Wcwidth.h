...
inline bool inRanges(const Range* ranges, size_t count, char32_t cp)
{
...
// Approximate wcwidth(): 0 for combining / zero-width code points, 2 for East
// Asian Wide/Fullwidth code points and emoji with default emoji presentation
// (the same classification ConPTY uses), 1 for everything else.
inline int charWidth(char32_t cp)
{
    ...
    static const detail::Range zero[] = {
        ...
        {0x0730, 0x074A}, {0x07A6, 0x07B0}, {0x0816, 0x082D}, {0x0859, 0x085B}, {0x08D3, 0x0902},
        {0x093A, 0x093A}, {0x093C, 0x093C}, {0x0941, 0x0948}, {0x094D, 0x094D}, {0x0951, 0x0957},
        {0x0962, 0x0963}, {0x0E31, 0x0E31}, {0x0E34, 0x0E3A}, {0x0E47, 0x0E4E}, {0x1AB0, 0x1AFF},
        {0x1DC0, 0x1DFF}, {0x200B, 0x200F}, {0x2028, 0x202E}, {0x2060, 0x2064}, {0x20D0, 0x20FF},
        {0xFE00, 0xFE0F}, {0xFE20, 0xFE2F}, {0xFEFF, 0xFEFF}, {0xE0100, 0xE01EF},
    };
    if (detail::inRanges(zero, sizeof(zero) / sizeof(zero[0]), cp))
        return 0;

    static const detail::Range wide[] = {
    ...
    if (detail::inRanges(wide, sizeof(wide) / sizeof(wide[0]), cp))
        return 2;
